...
const UpdateApplicationFormPopup = ({
  ...
  const handleChangeStatus = async () => {
    ...
    try {
      if (handleChangeStatusEndpoint === 'api1') {
        const response = await axios.post('https://vulkantechnologylabs.com:8000/api/licenserenewalrequest', formData);
  ...
  const handlepay = () => {
    ...
    const url = `https://vulkantechnologylabs.com:8000/lstripe/${id}`;
